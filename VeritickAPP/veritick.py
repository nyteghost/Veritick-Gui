    ...
    with indent(4, quote='>>>'):
        ...
        if Unreturned.empty and return_label_requested != 1: #or Check == "Yes":
                ...
                if Decision == "Cleared For Shipment":
                    puts(colored.green(Decision))
                    ##Does Address provided match Contact, if not, list together to compare. 
                    if staff == 0:
                        puts("FEL Email: "+ style.CYAN+FEL_Email+style.RESET)
                        puts('LG Email: ' + style.CYAN+str(LG_Email)+style.RESET)
                    elif staff ==1:
                        puts("Personal Email: "+ style.CYAN+FEL_Email)
                        puts('Staff Email: ' + style.CYAN+str(LG_Email)+style.RESET)
                    puts('Address: '+ style.CYAN+Address+style.RESET)
                    ...
                    if getShipFunc != False:
                        ...
                        if Equipment_Requested == 'charger':
                            ...
                            puts(style.CYAN+"Device"+style.RESET)
                            print(Equipment_Requested.strip())
                            print()
                            puts(style.CYAN+"Troubleshooting Notes"+style.RESET)
                            print(troubleshooting_notes.strip())
                            print()
                            puts(style.CYAN+"Return Label Method"+style.RESET)
                            print(Label_Method_Decision)
                            print()

                            if shipping_ratio >=85:
                                puts(style.CYAN+"Shipping information "+style.RESET +style.GREEN+str(shipping_ratio)+"%"+style.RESET+" match.")
                                ...
                                puts(style.CYAN+"Shipping information "+style.RESET+style.YELLOW+str(shipping_ratio)+"%"+style.RESET+" match.")
                                ...
                                puts(style.CYAN+"Shipping information "+style.RESET+style.RED+str(shipping_ratio)+"%"+style.RESET+" match.")
                            ...
                            if email_Ratio >=85:
                                puts(style.CYAN+"Email information "+style.RESET +style.GREEN+str(email_Ratio)+"%"+style.RESET+" match.")
                                ...
                                puts(style.CYAN+"Email information "+style.RESET+style.YELLOW+str(email_Ratio)+"%"+style.RESET+" match.")
                                ...
                                puts(style.CYAN+"Email information "+style.RESET+style.RED+str(email_Ratio)+"%"+style.RESET+" match.")
                    ...
                    if troubleshooting_notes:
                        puts("Troubleshooting: "+style.RED+troubleshooting_notes+style.RESET)
                    if ERI == 'x':
                        pass   
                    elif ERI == "":
                        pass
                        ...
                        while i < 1: 
                            ...
                            if printCheckVariable == 'Cleared For Shipment':
                                ...
                                puts(style.RED +printCheckVariable+style.RESET)
            ...
            if staff == 0:
                puts("FEL Email: "+ style.CYAN+FEL_Email+style.RESET)
                puts('LG Email: ' + style.CYAN+LG_Email+style.RESET)
                puts(style.RED +'This Family has Outstanding Equipment'+style.RESET)
            elif staff ==1:
                puts("Personal Email: "+ style.CYAN+FEL_Email+style.RESET)
                puts('Staff Email: ' + style.CYAN+str(LG_Email)+style.RESET)
                puts(style.RED +'This Staff member has Outstanding Equipment'+style.RESET)
